...
class ClaudeTasksReader:
    ...
    def read_tasks(self, task_list_dir: Path) -> dict[str, Any]:
        ...
        for json_path in json_files:
            ...
            mahabharatha_status = self._map_status(claude_status, blocked_by)

            task_id = data.get("id", json_path.stem)
            tasks[f"TASK-{task_id}"] = {
                "status": mahabharatha_status,
                "level": level,
                "title": title,
                "worker_id": None,
                "started_at": None,
    ...
    def _scan_dir_for_mahabharatha_tasks(self, dir_path: Path, feature_lower: str) -> tuple[int, bool]:
        ...
        Returns:
            Tuple of (mahabharatha_task_count, feature_matched).
        """
        mahabharatha_count = 0
        feature_match = False
        ...
        return mahabharatha_count, feature_match
