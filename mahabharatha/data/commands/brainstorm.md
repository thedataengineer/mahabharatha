# Mahabharatha Brainstorm: $ARGUMENTS
...
if [ -z "$DOMAIN" ]; then
  ...
  echo "Usage: /mahabharatha:brainstorm domain-or-topic"
  exit 1
fi
...
Call TaskCreate:
  ...
  - description: "Brainstorm session for {domain}. Researching, discovering, and generating issues via /mahabharatha:brainstorm."
...
After session completes (all phases done), call TaskUpdate to mark completed:
  ...
  - status: "completed"
  - description: "Brainstorm complete for {domain}. {N} issues created. Ready for /mahabharatha:plan {feature}."
...
```
/mahabharatha:brainstorm -- Discover opportunities and generate GitHub issues.

Usage: /mahabharatha:brainstorm domain-or-topic [flags]
...
Examples:
  ...
  /mahabharatha:brainstorm payment-processing --rounds 5
