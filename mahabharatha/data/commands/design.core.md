...
2. Runs `python -m mahabharatha.validate_commands` for structural checks
...
```json
{
  ...
  "verification": {
    "command": "python -m mahabharatha.validate_commands && python -m pytest {new_test_paths} -x --timeout=60 -q",
    "timeout_seconds": 120
  },
  "estimate_minutes": 5,
  "skills_required": [],
...
- Always include `python -m mahabharatha.validate_commands`
