...
class ModuleNode:
    ...
    Attributes:
        name: Fully-qualified module name (e.g. ``"mahabharatha.orchestrator"``).
...
class DependencyMapper:
    ...
    Usage::
        ...
        graph = DependencyMapper.build(Path("src"), package="mahabharatha")
    ...
    @staticmethod
    def build(root_dir: Path, package: str = "mahabharatha") -> DependencyGraph:
