"""Mahabharatha plugin system with ABCs and registry for quality gates, lifecycle hooks, and launchers."""
...
class LifecycleEvent:
    """An event emitted during Mahabharatha lifecycle phases."""
