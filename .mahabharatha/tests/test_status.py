...
class TestLevelStatus:
    ...
    def test_level_status_complete(self):
        ...
        complete = LevelStatus(level=0, total_tasks=5, completed_tasks=5, is_current=False)
        assert complete.is_complete is True

        incomplete = LevelStatus(level=0, total_tasks=5, completed_tasks=3, is_current=True)
