...
def merge_cmd(
    ...
    Examples:
        ...
        mahabharatha merge --target develop --skip-gates
    ...
    try:
        ...
        try:
            ...
            if result.success:
                ...
                console.print("\nResolve conflicts manually or use [cyan]mahabharatha retry[/cyan]")
                raise SystemExit(1)
...
def create_merge_plan(
    ...
    for worker_id, worker in workers.items():
        branch = f"mahabharatha/{feature}/worker-{worker_id}"
        branches.append(
            {
                "branch": branch,
                "worker_id": worker_id,
    ...
    return {
        ...
        "level": level,
        "target": target,
        "staging_branch": f"mahabharatha/{feature}/staging",
        "branches": branches,
