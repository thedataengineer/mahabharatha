...
from mahabharatha.backlog import generate_backlog_markdown
from mahabharatha.json_utils import dump as json_dump
from mahabharatha.json_utils import dumps as json_dumps
from mahabharatha.json_utils import load as json_load
from mahabharatha.logging import get_logger
from mahabharatha.step_generator import StepGenerator
...
def design(
    ...
    Examples:
        ...
        mahabharatha design --feature user-auth

        mahabharatha design --detail medium

        mahabharatha design --detail high --feature complex-feature
    ...
    try:
        ...
        if not feature:
            ...
            if not feature:
                ...
                console.print("Run [cyan]mahabharatha plan <feature>[/cyan] first")
                raise SystemExit(1)
    ...
    task_graph: dict[str, Any] = {
        ...
        "tasks": [
            ...
            },
            {
                ...
                "verification": {
                    "command": "test -f .mahabharatha/state/final-analysis.json",
                    "timeout_seconds": 300,
                },
                "estimate_minutes": 15,
            },
