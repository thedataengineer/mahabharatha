...
class TestGateResult:
    ...
    def test_gate_result_with_failures(self):
        ...
        result = GateResult(stage=2, passed=False, failures=["lint failed", "coverage below threshold"])
...
class TestQualityConfig:
    ...
    def test_quality_config_custom(self):
        ...
        config = QualityConfig(coverage_threshold=90, complexity_threshold=5, run_security_scan=True)
