...
#### `/mahabharatha:kurukshetra` — 4 flags missing from commands-quick.md AND wiki
...
#### `/mahabharatha:plan` — 1 flag missing from commands-quick.md AND wiki
| Flag | Code Location | Purpose |
|------|---------------|---------|
| `--from-issue` | `plan.py:24` | Import requirements from GitHub issue URL |

#### `/mahabharatha:debug` — 2 flags missing from commands-quick.md
| Flag | Code Location | Purpose |
|------|---------------|---------|
| `--deep` | `debug.py:1263` | Run system-level diagnostics |
| `--env` | `debug.py:1265` | Run environment diagnostics |

#### `/mahabharatha:merge` — 1 flag missing from commands-quick.md
| Flag | Code Location | Purpose |
|------|---------------|---------|
| `--target` | `merge_cmd.py:24` | Target branch (default: main) |

#### `/mahabharatha:retry` — 1 flag missing from commands-quick.md
| Flag | Code Location | Purpose |
|------|---------------|---------|
| `--worker` | `retry.py:21` | Assign task to specific worker |

#### `/mahabharatha:analyze` — 1 flag missing from commands-quick.md
| Flag | Code Location | Purpose |
|------|---------------|---------|
...
| `mahabharatha/data/commands/document.md` | ✅ Complete | `--tone` fully documented with usage |
