...
class TestTestResult:
    ...
    def test_result_creation(self):
        ...
        result = TestResult(total=10, passed=8, failed=2, skipped=0, duration_seconds=5.5)
...
class TestCoverageReport:
    ...
    def test_coverage_report_creation(self):
        ...
        report = CoverageReport(total_lines=1000, covered_lines=800, percentage=80.0, files={})
