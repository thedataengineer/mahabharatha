...
if [ -z "$TARGET" ]; then
  echo "ERROR: No target specified. Usage: /mahabharatha:explain <file|function|module>"
  exit 1
fi
...
```
/mahabharatha:explain — Educational code explanations with 4 progressive depth layers, powered by doc_engine AST extractors.
