"""Mahabharatha structured logging with JSON output and worker context."""
...
def get_logger(
    ...
    """
    logger = logging.getLogger(f"mahabharatha.{name}")
...
def setup_logging(
    ...
    # Get root mahabharatha logger
    root_logger = logging.getLogger("mahabharatha")
...
class StructuredFileHandler(logging.Handler):
    ...
    Bridges Python's logging module with Mahabharatha's structured JSONL logging.
    """
...
def setup_structured_logging(
    ...
    to the mahabharatha root logger. Also sets worker context.
