...
class TestGoalAnalysis:
    ...
    def test_analysis_to_dict(self):
        ...
        analysis = GoalAnalysis(goal="Test", complexity="low", domain="general", estimated_sub_goals=3)
...
class TestSpawnResult:
    ...
    def test_result_creation(self):
        ...
        analysis = GoalAnalysis(goal="Test", complexity="low", domain="general", estimated_sub_goals=2)
        result = SpawnResult(
            goal="Test",
            analysis=analysis,
            sub_goals=[],
    ...
    def test_result_to_markdown(self):
        ...
        analysis = GoalAnalysis(goal="Feature", complexity="medium", domain="api", estimated_sub_goals=3)
...
class TestGraphValidator:
    ...
    def test_validate_with_tasks_passes(self):
        ...
        validator = GraphValidator()
        sub_goals = [SubGoal(id="SG-1", description="Test", tasks=[{"id": "T1", "title": "Task"}])]
