...
from mahabharatha.doc_engine.extractor import ClassInfo, FunctionInfo, ImportInfo, SymbolExtractor, SymbolTable
from mahabharatha.doc_engine.templates import TEMPLATES
...
class DocRenderer:
    ...
    Usage::
        ...
        markdown = renderer.render(Path("mahabharatha/launcher.py"))
    """
