...
Extracted from mahabharatha/launcher.py. Uses subprocess.Popen to spawn worker
processes running mahabharatha.worker_main. Suitable for local development and testing.
"""
...
from mahabharatha.constants import LOGS_TASKS_DIR, LOGS_WORKERS_DIR, WorkerStatus
...
class SubprocessLauncher(WorkerLauncher):
    ...
    Uses subprocess.Popen to spawn worker processes running mahabharatha.worker_main.
