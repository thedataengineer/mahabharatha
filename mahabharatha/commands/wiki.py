...
DEFAULT_OUTPUT = ".mahabharatha/wiki"
...
def wiki(
    ...
    Examples:
        ...
        mahabharatha wiki --full

        mahabharatha wiki --dry-run

        mahabharatha wiki --full --push

        mahabharatha wiki --output docs/wiki/
    """
    ...
    try:
        ...
        mapper.build(project_root / "mahabharatha")

        # Find Python source files
        py_files = collect_files(project_root / "mahabharatha", extensions={".py"}).get(".py", [])
        ...
        # Push if requested
        if push:
            from mahabharatha.doc_engine.publisher import WikiPublisher
