...
Extracted from mahabharatha/launcher.py. Launches workers in Docker containers
...
from mahabharatha.env_validator import (
...
class ContainerLauncher(WorkerLauncher):
    ...
    CONTAINER_PREFIX = "mahabharatha-worker"
    WORKER_ENTRY_SCRIPT = ".mahabharatha/worker_entry.sh"
    ...
    def __init__(
        ...
        Args:
            ...
            network: Docker network name (default: mahabharatha-internal)
    ...
    def _build_container_cmd(
        ...
        main_repo = worktree_path.parent.parent.parent  # .mahabharatha-worktrees/feature/worker-N -> repo
        state_dir = main_repo / ".mahabharatha" / "state"
        ...
        cmd = [
            ...
            "-v",
            f"{state_dir.absolute()}:/workspace/.mahabharatha/state",  # Share state with orchestrator
        ]
    ...
    def monitor(self, worker_id: int) -> WorkerStatus:
        ...
        try:
            ...
            if running == "true":
                ...
                # the worker process exits. Check /tmp/.mahabharatha-alive marker file
