...
```json
{
  ...
  "containerEnv": {
    ...
    "Mahabharatha_BRANCH": "${localEnv:Mahabharatha_BRANCH:-main}"
  },
...
echo "═══════════════════════════════════════════════════"
echo "  Mahabharatha Worker Post-Create Setup"
echo "═══════════════════════════════════════════════════"
...
git config --global user.name "Mahabharatha Worker ${Mahabharatha_WORKER_ID:-0}"
...
echo "═══════════════════════════════════════════════════"
echo "  Mahabharatha Worker Starting"
...
```bash
# Run stack detection
mahabharatha security-rules detect --json-output
```
...
mahabharatha security-rules fetch --no-cache
```
...
Test single worker:
  Mahabharatha_WORKER_ID=0 devcontainer up --workspace-folder .

Next: Run /mahabharatha:plan {feature-name} to start planning
