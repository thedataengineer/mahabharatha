"""Merge coordination for Mahabharatha level completion."""
...
if TYPE_CHECKING:
    ...
    from mahabharatha.level_coordinator import GatePipeline
...
class MergeCoordinator:
    ...
    def finalize(
        ...
        commit = self.git.merge(
            staging_branch,
            message=f"Mahabharatha: Complete level merge from {staging_branch}",
        )
