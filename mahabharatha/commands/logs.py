...
def logs(
    ...
    Examples:
        ...
        mahabharatha logs --follow --level debug

        mahabharatha logs --tail 50 --feature user-auth
...
def _show_aggregated_logs(
    ...
    if not entries:
        ...
        console.print("[dim]Hint: Structured JSONL logs are in .mahabharatha/logs/workers/[/dim]")
        return
