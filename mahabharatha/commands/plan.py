...
def plan(
    ...
    Examples:
        ...
        mahabharatha plan --from-issue https://github.com/org/repo/issues/123
    ...
    try:
        ...
        if not feature and not from_issue:
            if interactive:
                ...
                console.print("Usage: mahabharatha plan <feature-name>")
                raise SystemExit(1)
        ...
        if not interactive:
            ...
            console.print("\nEdit the requirements file, then run [cyan]mahabharatha design[/cyan]")
            return
        ...
        console.print("  3. Run [cyan]mahabharatha design[/cyan] to generate task graph")
