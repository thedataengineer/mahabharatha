...
def action_commit(git: GitOps, push: bool, mode: str | None = None) -> int:
    ...
    """
    if mode:
        from mahabharatha.git.commit_engine import CommitEngine
...
def action_history(git: GitOps, since: str | None, cleanup: bool = False, base: str = "main") -> int:
    ...
    if cleanup:
        from mahabharatha.git.config import GitConfig
        from mahabharatha.git.history_engine import HistoryEngine
...
def action_pr(git: GitOps, base: str, draft: bool, reviewer: str | None) -> int:
    ...
    from mahabharatha.git.config import GitConfig
    from mahabharatha.git.pr_engine import PREngine
...
def action_release(git: GitOps, bump: str, dry_run: bool) -> int:
    ...
    from mahabharatha.git.config import GitConfig
    from mahabharatha.git.release_engine import ReleaseEngine
...
def action_review(git: GitOps, base: str, focus: str | None) -> int:
    ...
    from mahabharatha.git.config import GitConfig
    from mahabharatha.git.prereview import PreReviewEngine
...
def action_rescue(
    ...
    from mahabharatha.git.config import GitConfig
    from mahabharatha.git.rescue import RescueEngine
...
def action_bisect(
    ...
    from mahabharatha.git.bisect_engine import BisectEngine
    from mahabharatha.git.config import GitConfig
...
def git_cmd(
    ...
    Examples:
        ...
        mahabharatha git --action bisect --symptom "login broken" --test-cmd "pytest tests/"

        mahabharatha git --action ship --base main
