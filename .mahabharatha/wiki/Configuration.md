...
| `MAHABHARATHA_WORKER_ID` | Unique worker identifier |
| `MAHABHARATHA_FEATURE` | Feature name being built |
| `MAHABHARATHA_TASK_ID` | Current task identifier |
| `MAHABHARATHA_WORKTREE` | Git worktree path for the worker |
| `MAHABHARATHA_BRANCH` | Git branch name for the worker |
...
| `MAHABHARATHA_SPEC_DIR` | Path to feature spec files |
| `MAHABHARATHA_STATE_DIR` | Path to MAHABHARATHA state directory |
| `MAHABHARATHA_REPO_PATH` | Path to the main repository |
