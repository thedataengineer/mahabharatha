"""Status dashboard formatting for Mahabharatha — rendering for HEALTH, REPO MAP, and TOKEN sections.

Pure functions that transform heartbeat, escalation, progress, repo-index,
and token-aggregation data into ASCII table strings for the /mahabharatha:status dashboard.
"""
...
if TYPE_CHECKING:
    from mahabharatha.types import EscalationDict, HeartbeatDict
