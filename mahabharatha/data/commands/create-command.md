...
if [ -z "$ARGUMENTS" ]; then
  ...
  echo "Usage: /mahabharatha:create-command <name> [--interactive]"
  exit 1
fi
...
COMMAND_FILE="mahabharatha/data/commands/${NAME}.md"
...
TEMPLATE_FILE="mahabharatha/data/commands/_template.md"
...
Call TaskCreate:
  ...
  - description: "Creating new Mahabharatha command: {name}. Mode: {quick|interactive}."
...
```
/mahabharatha:create-command — Scaffold new Mahabharatha slash commands with Task ecosystem integration.

Usage:
  /mahabharatha:create-command <name> [--interactive]
...
Examples:
  /mahabharatha:create-command my-command             # Quick scaffold
  /mahabharatha:create-command my-command --interactive  # Wizard mode

Generated files:
  - mahabharatha/data/commands/{name}.md      Command file
