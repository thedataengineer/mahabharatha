...
|----------|-------------|
| `MAHABHARATHA_WORKER_ID` | Unique integer identifier for this worker. |
| `MAHABHARATHA_FEATURE` | Name of the feature being built. |
| `MAHABHARATHA_BRANCH` | Git branch assigned to this worker. |
