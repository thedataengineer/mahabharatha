...
class WorktreeManager:
    ...
    def merge_to_base(self, worker_id: str, base_branch: str = "main") -> MergeResult:
        ...
        # Merge worker branch
        result = self._run_git(["merge", "--no-ff", wt.branch, "-m", f"Merge {wt.branch}"], check=False)
    ...
    def merge_level_branches(self, level: int, worker_ids: list[str], base_branch: str = "main") -> LevelMergeResult:
