...
class MockStateManager:
    ...
    def transition_task_status(self, task_id: str, new_status: MockTaskStatus) -> tuple[bool, str]:
    ...
    def transition_level_status(self, level: int, new_status: MockLevelStatus) -> tuple[bool, str]:
    ...
    def advance_level(self) -> int:
        ...
        self._record_event("level_advanced", str(self.current_level), {"new_level": self.current_level})
        return self.current_level

    # --- Event Tracking Methods ---

    def _record_event(self, event_type: str, entity_id: str, data: dict | None = None) -> MockEvent:
