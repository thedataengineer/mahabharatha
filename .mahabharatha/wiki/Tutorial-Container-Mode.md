...
```
MAHABHARATHA_GIT_WORKTREE_DIR=/workspace/.git-worktree
MAHABHARATHA_GIT_MAIN_DIR=/repo/.git
```
...
MAHABHARATHA_CONTAINER_MEMORY=8g MAHABHARATHA_CONTAINER_CPUS=4.0 /mahabharatha:kurukshetra --workers=2 --mode container
```
...
```bash
docker exec mahabharatha-worker-0 env | grep MAHABHARATHA_GIT
# Should show:
# MAHABHARATHA_GIT_WORKTREE_DIR=/workspace/.git-worktree
# MAHABHARATHA_GIT_MAIN_DIR=/repo/.git
```
